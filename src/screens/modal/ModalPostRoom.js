...
import CreatePostModalRoom from '../CreatePost/CreatePostModalRoom';
...
const ModalPostRoom = ({ modalVisible, setModalVisible, opacityModal, setOpacityModal, setRoom, navigation }) => {
    return (
        <Modal
            animationType="slide"
            transparent={true}
